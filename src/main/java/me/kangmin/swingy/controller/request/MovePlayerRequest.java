...
public class MovePlayerRequest implements Request {

    @Min(1)
    @Max(4)
    @NotNull
    private final Integer input;
    private final RequestHandlerCode requestHandlerCode = RequestHandlerCode.MOVE_PLAYER;

    public MovePlayerRequest(Integer input) {
        this.input = input;
    }
