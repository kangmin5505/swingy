...
public class StudySubjectRequest implements Request {
    @Min(1)
    @Max(2)
    @NotNull
    private final Integer input;
    private final RequestHandlerCode requestHandlerCode = RequestHandlerCode.STUDY_SUBJECT;

    public StudySubjectRequest(Integer input) {
        this.input = input;
    }
